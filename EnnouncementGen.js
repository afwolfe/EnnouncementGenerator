/*
  ...
  Made TriggerManager to be able to automatically install time-based triggers to manage the sending of requests and
  the announcements as well as locking/unlocking the form.
